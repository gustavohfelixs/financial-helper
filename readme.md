...
Este projeto é um chatbot para Telegram que atua como um assistente financeiro. O bot é construído com Java 25, Spring Boot, LangChain4j e a API do Google Gemini. A aplicação é projetada para ser implantada de forma segura e escalável no Google Cloud Run.
...
- **Java 25**: Utiliza a versão mais recente do Java, aproveitando suas melhorias de performance e recursos de linguagem.
